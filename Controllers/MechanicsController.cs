...
namespace ASProjekt.Controllers
{
    public class MechanicsController : Controller
    {
        ...
        public MechanicsController(ASProjektContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Imie")] Mechanic mechanic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Imie")] Mechanic mechanic)
        {
            if (id != mechanic.Id)
            {
                return NotFound();
